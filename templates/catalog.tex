...
\rowcolors{2}{row1}{row2}
\begin{tabular}{ \BLOCK{ for _ in table.fields }l \BLOCK{ endfor } }
\rowcolor{black!60}\BLOCK{ for title in table.fields }\textcolor{white}{\textbf{\VAR{ title|escape_latex }}} \BLOCK{ if loop.last }\\\BLOCK{ else }& \BLOCK{ endif }\BLOCK{ endfor }
